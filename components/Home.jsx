...
export const Home = () => {
  return (
    <section
      id="home"
      className="flex flex-col gap-10 md:gap-2 md:flex-row md:justify-around -mt-44 md:mt-0 sm:px-4"
    >
      <div className="text-center md:max-w-lg md:my-auto md:pt-10">
        <h1 className="text-4xl">Asegura tu futuro aprendiendo de tecnología y programación</h1>
        <p className="text-center text-lg text-gray-200 py-6">
          Con la programación web puedes crear aplicaciones que impactan a
          millones de personas en todo el mundo. ¡Descubre cómo hacerlo!
        </p>
